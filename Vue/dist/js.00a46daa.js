...
exports.http = http;
},{"axios":"../node_modules/axios/index.js"}],"js/jogos.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./config":"js/config.js"}],"../node_modules/vue-hot-reload-api/dist/index.js":[function(require,module,exports) {
var Vue // late bind
var version
var map = Object.create(null)
...
var _jogos = _interopRequireDefault(require("./jogos"));
...
var _default = {
  ...
  methods: {
    listar: function listar() {
      ...
      _jogos.default.listar().then(function (res) {
        _this.loadJogos = res.data;
      });
    },
    ...
    remover: function remover(jogo) {
      var _this3 = this;

      _jogos.default.apagar(jogo).then(function (res) {
        _this3.listar();
      });
    }
  }
  ...
  return _c("div", { attrs: { id: "app" } }, [
    ...
    _c("div", { staticClass: "container" }, [
            ...
            directives: [
              {
                ...
                rawName: "v-model",
                value: _vm.jogo.nome,
                expression: "jogo.nome"
              }
            ],
            attrs: { type: "text", placeholder: "Nome" },
            domProps: { value: _vm.jogo.nome },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.jogo, "nome", $event.target.value)
              }
            }
          }),
          _vm._v(" "),
            ...
            directives: [
              {
                ...
                rawName: "v-model",
                value: _vm.jogo.tipo,
                expression: "jogo.tipo"
              }
            ],
            attrs: { type: "text", placeholder: "Nome" },
            domProps: { value: _vm.jogo.tipo },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.jogo, "tipo", $event.target.value)
              }
            }
          }),
          _vm._v(" "),
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.jogo.preco,
                expression: "jogo.preco"
              }
            ],
            attrs: { type: "text", placeholder: "Valor" },
            domProps: { value: _vm.jogo.preco },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.jogo, "preco", $event.target.value)
              }
            }
          }),
          _vm._v(" "),
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.jogo.quantidade,
                expression: "jogo.quantidade"
              }
            ],
            attrs: { type: "number", placeholder: "QTD" },
            domProps: { value: _vm.jogo.quantidade },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.jogo, "quantidade", $event.target.value)
              }
            }
          }),
          _vm._v(" "),
      ...
      _c("table", [
        ...
        _c(
          "tbody",
          _vm._l(_vm.loadJogos, function(jogo) {
            return _c("tr", { key: jogo.id }, [
              _c("td", [_vm._v(_vm._s(jogo.id))]),
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(jogo.nome))]),
              _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("nav", [
      _c("div", { staticClass: "nav-wrapper black darken-1" }, [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("button", { staticClass: "waves-effect waves-light btn-small" }, [
      _vm._v("Salvar"),
...
},{"./jogos":"js/jogos.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"js/index.js":[function(require,module,exports) {
"use strict";
